...
def comment_utiliser(data_freshness):
    ...
    st.image('resources/demo/bassins_natation_handicap.png', width=1000)
    ...
    st.image('resources/demo/bassins_natation_charente.png', width=800)
    ...
    st.image('resources/demo/infra_acces_handi_angouleme.png', width=800)
